...
def mess_text(message):
    if message.text == "/help":
        ...
        bot.send_photo(message.from_user.id, photo="https://pp.vk.me/c622728/v622728138/e6fe/oyZ3Ap2FO9E.jpg", caption='Основными направлениями деятельности клуба являются:\n'
